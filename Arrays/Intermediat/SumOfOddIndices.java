...
public class SumOfOddIndices {
	private static int[] sumOfOddIndices(int A[], int B[][]) {
		// Odd index prefix sum matrix banao pehle fir left and right nikalo uske bad agar left =0 ho to ans array me pf[r] dal do.
